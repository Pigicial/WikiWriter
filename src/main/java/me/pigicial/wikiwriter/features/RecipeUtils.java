...
public final class RecipeUtils {
    ...
    public static final int[] CRAFTING_TABLE_INGREDIENT_SLOTS = new int[]{10, 11, 12, 19, 20, 21, 28, 29, 30};
    public static final int[] FORGE_POSITION_TO_SLOT_MAP = new int[]{10, 11, 19, 20, 28, 29, 37, 38};
